...
export default class EngineDesign extends Component {
  ...
  render() {
    ...
    switch (type){
    	case "a":
    		chart=<iframe src="http://192.168.1.9/views/_6/-?:embed_code_version=3&:embed=y&:loadOrderID=0&:display_spinner=no&:showAppBanner=false&:display_count=no&:showVizHome=no&:toolbar=no"/>;
    		table=<iframe src="http://192.168.1.9/views/_6/-_1?:embed=y&:display_count=no&:showAppBanner=false&:showVizHome=no&:toolbar=no"/>;
    		break;
    	case "b":
    		chart=<iframe src="http://192.168.1.9/views/_6/-_2?:embed=y&:display_count=no&:showAppBanner=false&:showVizHome=no&:toolbar=no"/>;
    		table=<iframe src="http://192.168.1.9/views/_6/-_3?:embed=y&:display_count=no&:showAppBanner=false&:showVizHome=no&:toolbar=no"/>;
    		break;
    	default:
    		break;
    }
      ...
      <div className={`${styles.root} shadow-box`}>
        <Row type="flex" align="middle" justify="space-between" className="title-group m-b-10">
          <Row type="flex" align="middle" className="select-group">
            ...
            <div className="extra m-l-10"></div>
          </Row>
        </Row>
